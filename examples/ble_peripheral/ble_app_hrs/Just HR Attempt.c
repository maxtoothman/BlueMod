...
#define DEVICE_NAME                      "BLE Test"                               /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME                "Max Toothman"                      /**< Manufacturer. Will be passed to Device Information Service. */
...
//#define MIN_BATTERY_LEVEL                80                                         /**< Minimum simulated battery level. */
...
#define MIN_CONN_INTERVAL                MSEC_TO_UNITS(1000, UNIT_1_25_MS)           /**< Minimum acceptable connection interval (0.4 seconds). */
