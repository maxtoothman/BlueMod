...
#define DEVICE_NAME                      "HPEH Service"                               /**< Name of device. Will be included in the advertising data. */
...
static void gap_params_init(void)
{
    ...
    // Set appearence										  
		...
		//Following four lines were added as part of advertising tutorial
		//Changes the device address to be Private Resolvable - will change every time
		//the board is reset
...
static void advertising_init(void)
{
    ...
    ble_advdata_t advdata;
		...
		//Following five lines are used to initialize manuf_data structure
		//Added as part of advertising tutorial
    ...
    advdata.flags                   = BLE_GAP_ADV_FLAGS_LE_ONLY_GENERAL_DISC_MODE;
		//Following one line used to set the manufacturing data of advertising packet
		//Set as part of the advertising tutorial
...
static void buttons_leds_init(bool * p_erase_bonds)
{
    bsp_event_t startup_event;
		if (p_erase_bonds){
			SEGGER_RTT_WriteString(0,"p_erase_bonds is true\n");
		} else {
			SEGGER_RTT_WriteString(0,"p_erase_bonds is false\n");
		}
