...
static void hrs_c_evt_handler(ble_hrs_c_t * p_hrs_c, ble_hrs_c_evt_t * p_hrs_c_evt)
{
    ...
    switch (p_hrs_c_evt->evt_type)
    {
        case BLE_HRS_C_EVT_DISCOVERY_COMPLETE:
            ...
            APPL_LOG("Heart rate service discovered \r\n");
            break;
...
{
		APPL_LOG("Heart Rate collector initialization\r\n");
...
{
		APPL_LOG("Battery level collector initialization\r\n");
...
static void scan_start(void)
{
    ...
    {
				APPL_LOG("Selective scanning based on whitelist first\r\n");
