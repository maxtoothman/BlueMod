...
#define TARGET_UUID                BLE_UUID_OUR_BASE_UUID             /**< Target device name that application is looking for. */
...
{
    //APPL_LOG("\r\n\n\n							DB Disc Handler\r\n");
		ble_our_service_on_db_disc_evt(&m_ble_our_service_c, p_evt);
}
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        {
						//APPL_LOG("BLE GAP EVT Connected\r\n");
                    ...
                    //&& (extracted_uuid.type == p_target_uuid->type))
                {
                    ...
                    return true;
						...
						if ((p_data[index+2] == 0x48) && (p_data[index+3] == 0x50)){
							APPL_LOG("BLE HPEH Service Found\r\n");
							return true;
						}     
				}
        index += field_length + 1;
...
{
		APPL_LOG("BLE event dispatch\r\n");
		switch (p_ble_evt->header.evt_id) {
			case BLE_GAP_EVT_ADV_REPORT:
				APPL_LOG("		BLE_GAP_EVT_ADV_REPORT\r\n");
				break;
			case BLE_GAP_EVT_CONNECTED:
				APPL_LOG("		BLE_GAP_EVT_CONNECTED\r\n");
				break;
		}/*
			case BLE_GAP_EVT_CONN_PARAM_UPDATE_REQUEST:
			...
			case BLE_OUR_SERVICE_C_TEMP_EVT_NOTIFICATION:
				APPL_LOG("		BLE_HRS_C_EVT_HRM_NOTIFICATION\r\n");
				break;
			case BLE_GAP_EVT_SEC_PARAMS_REQUEST:
				APPL_LOG("		BLE_GAP_EVT_SEC_PARAMS_REQUEST\r\n");
				break;
			case BLE_GAP_EVT_AUTH_STATUS:
				APPL_LOG("		BLE_GAP_EVT_AUTH_STATUS\r\n");
				break;
			case BLE_GAP_EVT_CONN_SEC_UPDATE:
				APPL_LOG("BLE_GAP_EVT_CONN_SEC_UPDATE\r\n");
				break;
			case BLE_GATTS_EVT_SYS_ATTR_MISSING:
				APPL_LOG("		BLE_GATTS_EVT_SYS_ATTR_MISSING\r\n");
				break;
			case BLE_GAP_EVT_SEC_REQUEST:
				APPL_LOG("		BLE_GAP_EVT_SEC_REQUEST\r\n");
				break;
			case BLE_GATTC_EVT_PRIM_SRVC_DISC_RSP:
				APPL_LOG("		BLE_GATTC_EVT_PRIM_SRVC_DISC_RSP\r\n");
				break;
			case BLE_GATTC_EVT_CHAR_DISC_RSP:
				APPL_LOG("		BLE_GATTC_EVT_CHAR_DISC_RSP\r\n");
				break;
			case BLE_GATTC_EVT_DESC_DISC_RSP:
				APPL_LOG("		BLE_GATTC_EVT_DESC_DISC_RSP\r\n");
				break;
			case BLE_GAP_EVT_DISCONNECTED:
				APPL_LOG("		BLE_GAP_EVT_DISCONNECTED\r\n");
				break;
			case BLE_GAP_EVT_TIMEOUT:
				APPL_LOG("		BLE_GAP_EVT_TIMEOUT\r\n");
				break;
		}*/
...
int main(void)
{
    ...
    APPL_LOG("\r\n\n\nCentral HPEH Program\r\n");
		APPL_LOG("Our Service Id is %x\r\n", m_our_service_uuid.uuid);
